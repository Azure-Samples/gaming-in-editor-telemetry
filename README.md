...
3. Create the **Azure Function** Application and storage account and configure the connection strings in the application settings
...
1. [Visual Studio 2019 or later](https://visualstudio.microsoft.com/downloads/)
...
1. Set up the publish profile as described in the [Azure Documentation*](https://docs.microsoft.com/azure/azure-functions/functions-develop-vs#publish-to-azure)
...
Included with the project are two console apps for testing the service. Simply start these in a new debugger to send and read events.

## Publishing the code

1. Right-click the project name in Visual Studio and choose Publish
2. Create a **New profile**
3. Under Azure App Service, choose **Select Existing** and then click the **Create Profile** button
4. Locate the Azure Function App you created with the template and Click **OK**
5. Click **Publish**

## Locating your Authorization Key

[Azure Documentation For Authorization Keys](https://docs.microsoft.com/azure/azure-functions/functions-bindings-http-webhook#authorization-keys)
